...
AS $$
DECLARE
  project_url TEXT := 'https://ahdvblsnzrpjrdxcoxxv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFoZHZibHNuenJwanJkeGNveHh2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMDAwMjc0MCwiZXhwIjoyMDM1NTc4NzQwfQ.fdppbN29ZZly7zrhADlIcsKak2Q18MrYwKTa8c7jODI'; -- full access needed for http request to storage
